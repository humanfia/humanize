...
The rest of it is `tests/integration/runtime/test_epics.py`, which drives a stand-in agent and
asks what was written down. Here is the one thing that stand-in cannot show: a turn taken as a
...
What the two halves share -- a flow that opens one session, and a stand-in for a backend whose
