...
bounded unattended flow. DeepSeek Harness takes `compaction` and `session_compression`, the
two places its runtime composition departs from the SDK's own. It is frozen,
