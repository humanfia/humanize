...
export const FLOWS: Flow[] = [
  ...
  },
  {
    ...
    ends: 'the run’s budget, which the two spend between them',
    keeps: 'turn · rounds',
    place: 'flowverse',
    family: 'pair',
    bench: 'flame_chase',
  ...
  },
  {
    ...
    ends: 'its max rounds, for the loop of the three',
...
export const SHAPES: Record<string, Shape> = {
  ...
  parallel_flame_chase_git_pr: {
    ...
    lanes: [
      { id: 'co', name: 'the orchestrateor', note: 'plans once', tone: 6 },
