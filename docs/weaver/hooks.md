...
| [`agent.pursue`](/weaver/goals) | the **model**, against the objective | Claude Code, Codex, DeepSeek Harness, Kimi, ZCode |
...
did. The one exception is a hook that drove an agent which has been [stopped](/user/stopping):
...
- [Asking a person](/user/questions)
