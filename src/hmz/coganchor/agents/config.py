...
class Needs:
    ...
    Attributes:
      of_agent: What the backend filling the place has to serve, out of the agent vocabulary
        -- `goal`, `steer`, `shape`, `tools`, `fork`, `search`, `swarm`, `resume`, `narrate`,
        and a moment only some backends reach as `moment:<its own name>`, those being the ones
        a place has any reason to ask for. What every backend here serves counts as served, so
