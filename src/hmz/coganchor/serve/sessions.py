...
:class:`~hmz.coganchor.proto.Kind.CHUNK` frames as output arrives and closes the exchange
with a single :class:`~hmz.coganchor.proto.Kind.RSP`, so the server's reader loop is never
...
from hmz.coganchor.proto import CHUNK_SIZE, Channel, Frame, Stream
