...
Separate from :mod:`hmz.coganchor.providers.redirect` because this half needs ptrace and an
...
Which of the provider's paths depends on what the call is about to do with it. One that only asks
