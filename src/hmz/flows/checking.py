...
def catalogue() -> tuple[Capability, ...]:
    ...
    Returns:
      ...
      fork, each kind of token a backend says what it spent on, the faster tier some can
      be asked to serve at and the settings of their own the rest take -- and then where
      an agent's turns may land and how a turn's own commands are reached there.
    """
    import inspect
